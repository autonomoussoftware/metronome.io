      ...
      <div className="downloads__main-container">
        <div className="downloads__main-parallax-layer">
          <div className="downloads__content-container">
            ...
            {walletInstaller && (
              <a href={walletInstaller.url} className="btn">
          ...
          <div className="envelope__footer" id="download-options">
            ...
            <div className="envelope__footer-downloads">
              <ul>
                <li>
                  <a href={walletInstallers['Mac OS'].url} className="btn">
                    Download For Mac OS
                  </a>
                </li>
                <li>
                  <a href={walletInstallers['Windows'].url} className="btn">
                    Download For Windows
                  </a>
                </li>
                <li>
                  <a href={walletInstallers['Ubuntu'].url} className="btn">
                    Download For Linux
                  </a>
                </li>
              </ul>
            ...
            >
              <a href={baseReleaseUrl} target="_blank">
                View all releases
              </a>
            </div>
            ...
            <div className="envelope__footer-downloads mb-5">
              <ul>
                <li>
                  <a href={walletInstallers['iOS'].url} className="">
                    <img
                ...
                <li>
                  <a href={walletInstallers['Android'].url} className="">
                    <img
                      alt="Get it on Google play"
                      src="/images/gplay-btn.svg"
                    />
                  </a>
                </li>
              </ul>
