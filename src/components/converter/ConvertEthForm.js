...
class ConvertEthForm extends Component {
  static propTypes = {
  ...
  sendTransaction = e => {
    ...
    showWaiting({ message: `Finish this Conversion in ${web3Provider}` })
      ...
      web3.eth
        ...
        .then(gasData =>
          this.contract.methods
            ...
            .send({ ...txObject, ...gasData })
            .on('transactionHash', function(hash) {
              showWaiting({
                hash,
                message: 'Waiting for Conversion to be mined'
              })
            })
    ...
    return (
      <Container>
        ...
        <Form onSubmit={this.sendTransaction}>
          <ConvertToggle onToggle={onToggle} convertFrom="eth" />
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withWeb3(withProviderPermission(ConvertEthForm)))
